...
#     basemask = basemask - 1
#     oDataSet = DataSet()
#     base = np.loadtxt("GLCM/EXP_02/FEATURES_M{}_CM8b.txt".format(M), usecols=basemask, delimiter=",")
#     classes = np.loadtxt("GLCM/EXP_02/FEATURES_M{}_CM8b.txt".format(M), dtype=object, usecols=24, delimiter=",")
...
#
#         oData.insert_model(svm, "temp2.txt")
#         oDataSet.append(oData)
#     oExp.add_data_set(oDataSet,
#                       description="  50 execucoes SVM_{} base FLUXO WON 10att arquivos em FEATURES_M{}_CM8b.txt. ".format(
#                           KERNEL,M))
#     oExp.save("Objects/EXP08_SVM_{}_{}b.gzip".format(KERNEL, MOLD))

oExp = Experiment.load("Objects/EXP08_SVM_{}_{}b.gzip".format(KERNEL, MOLD))
