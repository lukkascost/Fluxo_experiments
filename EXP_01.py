...
for j in range(50):
    ...
    oData.random_training_test_by_percent([353, 382, 379, 70], 0.8)
    svm = ml.SVM_create()
...
oExp.add_data_set(oDataSet,
                  description="  50 execucoes SVM_{} base Injetoras arquivos em FEATURES_M1_CM8b.txt. ".format(
                      KERNEL))
oExp.save("Objects/EXP01_SVM_{}_{}b.gzip".format(KERNEL, MOLD))

oExp = oExp.load("Objects/EXP01_SVM_{}_{}b.gzip".format(KERNEL, MOLD))
