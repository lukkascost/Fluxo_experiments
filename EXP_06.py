...
oExp = Experiment()
oDataSet = DataSet()
base = np.loadtxt("GLCM/EXP_03/FEATURES_M1_CM8b.txt", usecols=range(24), delimiter=",")
...
oExp.add_data_set(oDataSet,
                  description="  50 execucoes SVM_{} base time-Frequency GLCM 24att arquivos em FEATURES_M1_CM8b.txt. ".format(
                      KERNEL))
oExp.save("Objects/EXP06_SVM_{}_{}b.gzip".format(KERNEL, MOLD))

oExp = oExp.load("Objects/EXP06_SVM_{}_{}b.gzip".format(KERNEL, MOLD))
