...
cols = np.array([1,2,3,4,6,7,8,9,11,13,15,16,17,20,22,23])
cols = cols-1

attributes = np.loadtxt("../GLCM/EXP_01/FEATURES_M1_CM8b.txt", usecols=cols, delimiter=",")
...
ATTRIBUTES = [1,2,3,4,6,7,8,9,11,13,15,16,17,20,22,23]
