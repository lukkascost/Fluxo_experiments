...
# for M in range(1,8):
#     oDataSet = DataSet()
#     base = np.loadtxt("GLCM/EXP_02/FEATURES_M{}_CM8b.txt".format(M), usecols=range(24), delimiter=",")
...
#                       description="  50 execucoes SVM_{} base FLUXO WON 24Att arquivos em FEATURES_M{}_CM8b.txt. ".format(
#                           KERNEL, M))
#     oExp.save("Objects/EXP07_SVM_{}_{}b.gzip".format(KERNEL, MOLD))

oExp = Experiment.load("Objects/EXP07_SVM_{}_{}b.gzip".format(KERNEL, MOLD))
